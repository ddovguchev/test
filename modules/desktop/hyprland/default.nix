        ...
        wayland.windowManager.hyprland = {
          ...
          settings = {
            ...
            bind = [
              ...
              # Переключение раскладки (us ↔ ru): F12 ИЛИ Alt+Shift+Пробел ИЛИ Super+Alt+K
              ", F12, exec, ${getExe keyboardswitch}"
              "ALT SHIFT, space, exec, ${getExe keyboardswitch}"
            ...
            monitor = [
              # 2560x1080 @ 200 Hz. availableModes из EDID остаётся 60 — режим 200 задаётся modeline.
              # Монитор должен быть в разъёме видеокарты NVIDIA, не в материнской плате.
              ",modeline 612.00 2560 2616 2648 2728 1080 1081 1084 1125 +hsync -vsync,auto,1"

              # My Monitors (highrr = max Hz; find desc with: hyprctl monitors)
              "desc:BNQ BenQ EW277HDR 99J01861SL0,highrr,-1920x0,1"
              "desc:BNQ BenQ EL2870U PCK00489SL0,highrr,0x0,2"
              "desc:BNQ BenQ xl2420t 99D06760SL0,highrr,1920x-420,1,transform,1" # 5 for flipped
            ];
