...

{
    ...
    programs.zsh = {
        ...
        shellAliases = {
            ...
            neofetch = "neofetch --source ${settings.dotfilesDir}/home-manager/apps/neofetch/snufkin.txt";
            git-clean = "git clean -xfd; git submodule foreach git clean -xfd";
            guix-activate = ". '${config.home.homeDirectory}/.config/guix/current/etc/profile'";
            ytfzf = "ytfzf -T chafa";
